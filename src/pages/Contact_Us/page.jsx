...
const ContactPage = () => {
  ...
  const contactDetails = [
    ...
    },
    {
      ...
      title: "Address",
      details: [
        "A-303, Academic Building, Okhla Industrial Estate, Phase III, IIIT-D",
      ],
      link: "https://www.google.com/maps/search/?api=1&query=Indraprastha+Institute+of+Information+Technology,Delhi",
    },
    {
        ...
        <Container maxWidth="lg">
          <Box className="hero-content">
            ...
            <Typography variant="body1" className="hero-description">
              Connect with our team for personalized support, answers to your
              queries, and collaboration opportunities.
            </Typography>
          </Box>
        </Container>
      </Box>
              ...
              <Box sx={{ height: "100%", position: "relative" }}>
                ...
                >
                  <Typography
                    variant="h6"
                    fontWeight={600}
                    sx={{ mb: 1, color: "#00B2B2" }}
                  >
                    IIIT-Delhi R&D Building
                  </Typography>
                  <Typography variant="body2" sx={{ mb: 2, lineHeight: 1.6 }}>
                    A-303, Academic Building, Okhla Industrial Estate, Phase -
                    III, IIIT-D
                  </Typography>
                  <Button
                    variant="outlined"
                    ...
                    href="https://www.google.com/maps/dir/?api=1&destination=Indraprastha+Institute+of+Information+Technology,Delhi"
                    target="_blank"
                    sx={{
                      borderColor: "#00B2B2",
                      color: "#00B2B2",
