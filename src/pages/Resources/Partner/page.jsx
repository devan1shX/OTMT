        ...
        <Container maxWidth="lg">
          <Box className="hero-content">
            ...
            <Typography variant="body1" className="hero-description">
              ...
              work, explore licensing opportunities for cutting-edge technology
              we're here to support you every step of the way. We are committed
              to providing high-quality solutions tailored to your needs and
              fostering meaningful collaborations. We're excited to work with
              you and help bring your vision to life.
            </Typography>
