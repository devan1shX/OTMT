  ...
  const navItems = [
    {
      ...
      children: [
        {
          label: "Facilitate Innovation",
          path: "/Services/Facilitate_Innovation",
        },
        {
          label: "Startup Facilitation",
          path: "/Services/Startup_Facilitation",
        },
    ...
    <Box className="desktop-menu">
      {navItems.map((item, index) => (
        <Box
          key={index}
          className={`menu-item ${
            activeParentMenu === item.label ? "active" : ""
          }`}
                    ...
                    {item.children.map((child, childIndex) => (
                      <Box
                        ...
                        className={`dropdown-item ${
                          activeChildMenu === child.label ? "active" : ""
                        }`}
                        onMouseEnter={
                          child.children
                            ? (e) =>
                                handleChildMenuEnter(e, item.label, child.label)
                            : () => handleNonSubmenuHover(item.label)
                        }
                        onMouseLeave={
                          child.children ? handleChildMenuLeave : null
                        }
                      >
                        {child.children ? (
                          <>
                            ...
                            >
                              <Paper
                                ...
                                onMouseEnter={() =>
                                  handleSubmenuEnter(item.label, child.label)
                                }
